...
import image5 from "../Blss-bond (2).png";
import image6 from "../Haveyum.png";
...
export const PROJECTS = [
  ...
  },
  {
    ...
    name: "Google Doc",
    about:
      "This project showcases a CSS-based implementation combined with a touch of React to enhance the functionality of a Google Docs-like application. By leveraging CSS styling and React components, this project offers an intuitive and visually appealing interface for creating and editing documents.",
  ...
  },
  {
    ...
    name: "Kanban Board",
    about:
      ":This project introduces a simple implementation of a Kanban Board, an effective tool for visualizing and managing work tasks. The Kanban Board utilizes Post-it notes to represent tasks and their statuses, providing an intuitive system for tracking progress.",
    catagory: "Productivity",
    src: image3,
    githubLink:
      "https://github.com/shubham-tiwari171/kanban-project/tree/development#README.md",
